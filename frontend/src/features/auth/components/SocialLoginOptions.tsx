...
export const SocialLoginOptions: React.FC = () => {
  return (
    <div className="w-full space-y-4">
      <h2 className="text-2xl font-bold text-center mb-8">Hoặc đăng nhập với</h2>

      <button className="w-full flex items-center justify-center gap-3 p-4 rounded-2xl border hover:bg-pink-100 transition-colors">
        ...
        <span className="font-medium">Đăng nhập bằng TikTok</span>
      </button>
      ...
      <div className="text-center text-sm text-gray-600 mt-6 px-4">
